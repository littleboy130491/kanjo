...
class ProposalContentDefaultSeeder extends Seeder
{
    ...
    {
        return [
            'brief' => '<p>Thank you for requesting a quotation for your professional website needs. We hope to be the right partner for you.</p><p>Based on our discussion with our consulting team, here are your website requirements:</p><ol><li>Modern design that highlights the credibility and professionalism of your business/company</li><li>Responsive display that adapts to 3 device sizes (desktop, mobile phone, and tablet) so the website layout is always optimal</li><li>A fast and secure website to access</li></ol><p>Feature details will be explained further in the features section.</p>',
            ...
            'features' => '<ol><li>You can use all available standard features (examples can be seen <a href="/features" target="_blank">here</a>)</li><li>Unlimited standard pages (can be created independently)</li><li>Dual Language Feature (auto translation by Gtranslate)</li><li>Dual Language Feature (manual translation)</li><li>WhatsApp Button Chat</li><li>Image or video banner</li><li>Gallery to display photos and company information</li><li>Google Map on the contact page</li><li>Contact Form</li><li>Social media connection (links to social media pages)</li><li>Archive Posts: article directory (blog) page to list articles with categories, sub-categories, and tags</li><li>Single Post: individual page for each article post containing further detailed content</li><li>Archive Products: directory/catalog page to list products</li><li>Single Product: individual page for each product to display further information (no e-commerce system)</li><li>On-page SEO: custom meta title/description settings and optimization for each page</li></ol>',
            'server' => '<ol><li>High Performance Cloud Server</li><li>High speed with 99.9% uptime</li><li>Average load speed under 4 seconds</li><li>Capacity up to 2000 unique visitors per day</li><li>SSD Disk Space 8GB</li><li>SSD Disk Space 20GB</li><li>Unlimited Bandwidth</li></ol>',
            'assets' => '<ol><li>Premium stock assets from freepik.com</li><li>Premium stock assets from elements.envato.com</li></ol>',
            'security' => '<ol><li>SSL (Secure Socket Layer) with A rating to secure visitors and improve website reputation in search engines</li><li>Anti-Malware protection against viruses and hackers</li><li>Protection against Brute Force and DDoS</li><li>Auto-banned IP with suspicious history</li><li>Daily malware scanning</li><li>Blacklist foreign hostnames attempting login with admin credentials</li><li>Daily data backup on server or Google Drive</li></ol>',
            'support' => '<ol><li>Upload up to 20 images / products / posts to the website for initial content</li><li>Major Revision: major website changes (structure, flow, layout, functions, and visual design concept) during the project timeline, up to 2 revisions.</li><li>Major Revision: major website changes (structure, flow, layout, functions, and visual design concept) during the project timeline, up to 3 revisions.</li><li>Major Revision: major website changes (structure, flow, layout, functions, and visual design concept) during the project timeline, up to 4 revisions.</li><li>Major Revision: major website changes (structure, flow, layout, functions, and visual design concept) up to 30 days after website completion, up to 8 revisions.</li><li>Minor Revision: minor website changes (text, image, color) up to 7 days after website completion</li><li>Minor Revision: minor website changes (text, image, color) up to 30 days after website completion</li><li>Server support: support from server side (uptime, performance, SSL configuration, server security) for 12 months</li><li>Server support: support from server side (uptime, performance, SSL configuration, server security) for 24 months</li><li>Application (web) support: support from web side (web performance, bugs and troubleshooting) for 6 months</li><li>Application (web) support: support from web side (web performance, bugs and troubleshooting) for 12 months</li><li>Application (web) support: support from web side (web performance, bugs and troubleshooting) for 24 months</li><li>Help Desk support: support from Imajiner team via WhatsApp group whenever issues are found, for 6 months</li><li>Help Desk support: support from Imajiner team via WhatsApp group whenever issues are found, for 12 months</li><li>Update support: assistance from Imajiner team to update website content up to 3 requests/month, non-accumulative</li><li>Update support: assistance from Imajiner team to update website content up to 5 requests/month, non-accumulative</li><li>Update support: assistance from Imajiner team to update website content up to 10 requests/month, non-accumulative</li><li>Update support: assistance from Imajiner team to update website content up to 15 requests/month, non-accumulative</li><li>Update support: assistance from Imajiner team to update website content up to 20 requests/month, non-accumulative</li><li>Technical support: support from Imajiner team for feature changes, web structure, and other technical adjustments, up to 2 hours</li><li>Technical support: support from Imajiner team for feature changes, web structure, and other technical adjustments, up to 4 hours</li><li>Technical support: support from Imajiner team for feature changes, web structure, and other technical adjustments, up to 6 hours</li><li>Technical support: support from Imajiner team for feature changes, web structure, and other technical adjustments, up to 8 hours</li></ol>',
            'additional_benefit' => '<ol><li>Premium &amp; interactive custom design</li><li>Source code provided</li><li>Domain with .com / .co.id / .id extension (optional)</li><li>Professional custom design up to 10 main pages</li><li>Professional custom design up to 15 main pages</li><li>Professional custom design up to 20 main pages</li><li>Dual Language Feature with Advanced Translation (manual input)</li><li>Live Chat contact to make it easier for website visitors to contact through Live Chat (optional)</li><li>Server with SSD Disk Space 20GB</li><li>Instagram Auto Feed</li><li>Multi-admin WhatsApp Button</li><li>MailChimp integration for newsletter subscription</li><li>Archive Posts Feature: article archive (blog) page to list posts with categories, sub-categories, and tags</li><li>Single Post Feature: individual page for each article post containing further detailed content</li><li>Archive Products Catalogue Feature: catalog page to list products</li><li>Single Product Feature: individual page for each product to display further information (no e-commerce system)</li><li>Professional Translation Service (ENG / ID) up to 5000 words</li><li>Professional Copywriting Service (ENG / ID) up to 5000 words</li><li>Premium Stock Assets (photo, icon, video) up to 30 assets</li><li>High Performance Cloud Server: <ul><li>High speed with 99.9% uptime</li><li>Average load speed under 4 seconds</li><li>Capacity up to 2000 unique visitors per day</li><li>SSD Disk Space 8GB</li><li>Unlimited Bandwidth</li></ul></li><li>High Performance Cloud Server: <ul><li>High speed with 99.9% uptime</li><li>Average load speed under 4 seconds</li><li>Capacity up to 2000 unique visitors per day</li><li>SSD Disk Space 20GB</li><li>Unlimited Bandwidth</li></ul></li><li>High Performance Cloud Server: <ul><li>1vCPU, 2GB RAM</li><li>High speed with 99.9% uptime</li><li>Average load speed under 4 seconds</li><li>Capacity up to 2000 unique visitors per day</li><li>SSD Disk Space 50GB</li><li>Unlimited Bandwidth</li></ul></li><li>SSL (Secure Socket Layer) with A rating to secure visitors and improve website reputation in search engines</li><li>Daily data backup on server or Google Drive</li><li>Major Revision: major website changes (structure, flow, layout, function, and visual design concept) up to 30 days after website completion, up to 8 revisions.</li><li>Minor Revision: minor website changes (text, image, color) up to 30 days after website completion</li><li>Server support: support from server side (uptime, performance, SSL configuration, server security) for 12 months</li><li>Application (web) support: support from web side (web performance, bugs and troubleshooting) for 12 months</li><li>Help Desk support: support from Imajiner team via WhatsApp group whenever issues are found, for 6 months</li><li>Help Desk support: support from Imajiner team via WhatsApp group whenever issues are found, for 12 months</li><li>Update support: assistance from Imajiner team to update website content up to 5 requests/month, non-accumulative</li><li>Update support: assistance from Imajiner team to update website content up to 10 requests/month, non-accumulative</li><li>Update support: assistance from Imajiner team to update website content up to 15 requests/month, non-accumulative</li><li>Update support: assistance from Imajiner team to update website content up to 20 requests/month, non-accumulative</li><li>Technical support: support from Imajiner team for feature changes, web structure, and other technical adjustments, up to 4 hours</li><li>Technical support: support from Imajiner team for feature changes, web structure, and other technical adjustments, up to 6 hours</li><li>Technical support: support from Imajiner team for feature changes, web structure, and other technical adjustments, up to 8 hours</li><li>Technical support: support from Imajiner team for feature changes, web structure, and other technical adjustments, up to 10 hours</li></ol>',
            'payment' => '<p>This quotation is valid for 30 days from the issue date.</p><p>If you agree to this quotation, you can make an initial payment (DP) of 50% to the following account.</p><b><p>Bank Central Asia (BCA)<br>Account Number 002-8888-786<br>under the name of PT DIGITAL CITRA KREATIF</p></b>',
...
<h3>12. Meetings</h3>
<ol>
    <li>The client gets 2 online meetings during project execution.</li>
    <li>Additional online meetings may be conducted as needed (additional fees may apply).</li>
    <li>We do not provide meetings with client-appointed third parties (for example: vendor / client customer) without prior agreement.</li>
...
<ol>
    ...
    <li>We do not cover renewal costs for domain and hosting purchased independently by the client, unless the service is transferred to our account.</li>
...
HTML,
    ...
    private static function defaultValueId(): array
    {
        return [
            ...
            'payment' => '<p>Surat penawaran ini berlaku 30 hari sejak diterbitkan.</p><p>Apabila Anda menyetujui penawaran tersebut, Anda dapat melakukan pembayaran awal (DP) sebesar 50% ke rekening berikut.</p><b><p>Bank Central Asia (BCA)<br>No. Rekening 002-8888-786<br>atas nama PT DIGITAL CITRA KREATIF</p></b>',
            'terms_condition' => <<<'HTML'
