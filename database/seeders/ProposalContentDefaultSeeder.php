...
class ProposalContentDefaultSeeder extends Seeder
{
    ...
    private static function defaultValueEn(): array
    {
        return [
            ...
            'payment' => '<p>This quotation is valid for 30 days from the issue date.</p><p>If you agree to this quotation, you can make an initial payment (DP) of 50% to the following account.</p><p>Bank Central Asia (BCA)<br>Account Number 002-8888-786<br>under the name of PT DIGITAL CITRA KREATIF</p>',
...
HTML,
    ...
    private static function defaultValueId(): array
    {
        return [
            ...
            'payment' => '<p>Surat penawaran ini berlaku 30 hari sejak diterbitkan.</p><p>Apabila Anda menyetujui penawaran tersebut, Anda dapat melakukan pembayaran awal (DP) sebesar 50% ke rekening berikut.</p><p>Bank Central Asia (BCA)<br>No. Rekening 002-8888-786<br>atas nama PT DIGITAL CITRA KREATIF</p>',
            'terms_condition' => <<<'HTML'
