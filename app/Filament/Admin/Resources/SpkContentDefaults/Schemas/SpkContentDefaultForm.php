        ...
        return $schema
            ->components([
                ...
                Section::make('SPK Default Content')
                    ->description('Party identification and the cover title are rendered from SPK party fields and subject, not this template. Placeholders like {{ offer_name }}, {{ offer_price }}, and {{ offer_timeline }} use the selected offer when creating from a proposal (default Offer 1). Explicit Offer 1/2 placeholders: {{ offer_name_1 }}, {{ offer_price_1 }}, {{ offer_timeline_1 }}, {{ offer_name_2 }}, {{ offer_price_2 }}, {{ offer_timeline_2 }}.')
                    ->schema([
                        Translate::make()
                            ->exclude(
